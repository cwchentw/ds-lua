...
-- statistics and data mining, mostly in Lua.  Since Lua is a slow language
-- compared with C/C++, you should not rely on this module for critical tasks.
-- In addition, this module is still in alpha stage; the API may change without
-- warning.
--
...
-- language features, the former outperforms the latter by about 10x-50x.
-- Therefore, this library targets LuaJIT.
-- @module ds
local ds = {}
